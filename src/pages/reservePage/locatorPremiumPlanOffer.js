export class ReservePremiumPlanLocator {
    constructor(page) {
        this.headerPremiumPlan = page.locator('h4:has-text("Premium plan")');
        ...
        this.headerConfirmPremiumPlan = page.getByRole('heading', { name: 'Confirm Reservation' });
