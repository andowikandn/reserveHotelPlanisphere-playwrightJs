export class ReserveEconomicalLocator {
    constructor(page) {
        this.headerEconomical = page.locator('h4:has-text("Economical")');
        ...
        this.headerConfirmEconomical = page.getByRole('heading', { name: 'Confirm Reservation' });
