export class ReservePrivateOnsenLocator {
    constructor(page) {
        this.headerPrivateOnsenOffer = page.locator('h4:has-text("With private onsen")');
        ...
        this.headerConfirmPrivateOnsen = page.getByRole('heading', { name: 'Confirm Reservation' });
