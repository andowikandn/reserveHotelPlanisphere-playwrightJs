export class ReserveStayWithoutMealsLocator {
    constructor(page) {
        this.headerStayWithoutMealsOffer = page.locator('h4:has-text("Staying without meals")');
        ...
        this.headerConfirmStayWithoutMeals = page.getByRole('heading', { name: 'Confirm Reservation' });
