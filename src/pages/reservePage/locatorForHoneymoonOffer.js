export class ReserveForHoneymoonLocator {
    constructor(page) {
        this.headerForHoneymoon = page.locator('h4:has-text("For honeymoon")');
        ...
        this.headerConfirmForHoneymoon = page.getByRole('heading', { name: 'Confirm Reservation' });
